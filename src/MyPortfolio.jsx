    ...
    <div className={`${themeClass} min-h-screen transition-colors duration-300`}>
      ...
      <main id="home">
        ...
        <section id="projects" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <SectionHeading
            eyebrow="Projects"
            title="Projects section ready for your best work."
            text="This layout is already prepared for live projects, case studies, and GitHub links. For now, it keeps the portfolio visually complete while you replace placeholders with your real builds."
            mutedClass={mutedClass}
          />
